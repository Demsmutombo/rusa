        ...
        <template #body>
          ...
          >
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400">
              Plan your next big moment or edit an event to stay on track
            </p>
...
onMounted(() => {
  events.value = [
    ...
    },
    {
      id: '2',
      title: 'Meeting',
      start Date(Date.now() + 86400000).toISOString().split('T')[0],
      extendedProps: { calendar: 'Success' },
    },
    {
      id: '3',
      title: 'Workshop',
      start Date(Date.now() + 172800000).toISOString().split('T')[0],
      end Date(Date.now() + 259200000).toISOString().split('T')[0],
