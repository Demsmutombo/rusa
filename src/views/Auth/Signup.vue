              ...
              <form @submit.prevent="handleSubmit">
                <div class="space-y-5">
                  ...
                  <div>
                    <button
                      type="submit"
                      class="w-full py-3 font-medium text-white bg-brand-500 rounded-lg hover:bg-brand-600 sm:py-4 dark:bg-brand-500 dark:hover:bg-brand-600 transition"
                    >
                      S'inscrire
                    </button>
                  </div>
...
// Autoplay simple - ralenti
const startAutoplay = () => {
  autoplayInterval = window.setInterval(() => {
    nextSlide()
  }, 6000) // Changé de 4000ms à 6000ms (6 secondes)
}
...
const previousSlide = () => {
  currentSlide.value = currentSlide.value === 0 ? 6 : currentSlide.value - 1
}
